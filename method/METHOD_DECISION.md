...
3. **Find at least 8 comparable studies, read their methods sections, fill a
   ...
   each paper's actual analysis practice — quantitative: which test or model,
   how effect sizes and confidence intervals are reported, how multiple
   comparisons are corrected; qualitative: the analytic stance (reflexive thematic
...
not on matching some reference answer.
